...
<div class="relative">
    <!-- Background Image -->
	<img src="{{ asset('images/jam-bg.png') }}" alt="Banner Image"
     class="w-full object-cover"
     style="position: absolute; height: 500px;  width: 100%; image-rendering: auto;">

    <!-- Text Overlay -->
    <div class="absolute inset-0 flex flex-col text-center text-white" style="position: absolute; top: 140px; left: -350px;">
        <h1 class="text-3xl font-bold mb-4" style="text-shadow: 3px 3px 8px rgba(0, 0, 0, 0.6);">
            JAM LINER Online Booking
        </h1>
    </div>
...
<img src="{{ asset('images/jam-map.png') }}" alt="Banner Image"
         style="position: absolute; left: 0px; top:740px;  height: 600px; width: 100%;">


		 <img src="{{ asset('images/jam-sched.png') }}" alt="Banner Image"
         style="position: absolute; left: 200px; top: 1440px;  height: 1300px; width: 70%;">
...
<footer class="bg-black text-white py-6 mt-80 w-full" style="position:absolute; top:2500px;">
