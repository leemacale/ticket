...
<div class="relative">
    <!-- Background Image -->
	<img src="{{ asset('images/dltbbus.png') }}" alt="Banner Image"
     class="w-full object-cover"
     style="position: absolute; height: 500px;  width: 100%; image-rendering: auto;">

    <!-- Text Overlay -->
    <div class="absolute inset-0 flex flex-col text-center text-white" style="position: absolute; top: 140px; left: -450px;">
...
<img src="{{ asset('images/dltb-map.png') }}" alt="Banner Image"
         style="position: absolute; left: 0px; top:740px;  height: 600px; width: 100%;">


		 <img src="{{ asset('images/dltb-sched.png') }}" alt="Banner Image"
         style="position: absolute; left: 120px; top: 1440px;  height: 990px; width: 80%;">
