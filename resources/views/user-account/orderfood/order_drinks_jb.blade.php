...
<body>
    ...
    <button class="brand-button selected">
		...
		<li class="active"><a href="{{ route('user.order_drinks_jb') }}"><img src="{{ asset('images/drinks.png') }}" alt="Desserts" class="sidebar-icon">Drinks</a></li>
                </ul>
            </div>
            ...
            <div class="products">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                    ...
                    <button class="product-item">
                        <img src="{{ asset('images/orangejuice.png') }}" alt="Yum Burger">
					...
					<button class="product-item">
                        <img src="{{ asset('images/icedtea.webp') }}" alt="Cheese Burger">
                        <p><strong>Iced Tea</strong></p>
                        <p>40 php</p>
                    </button>

					<button class="product-item">
                        <img src="{{ asset('images/coke.webp') }}" alt="Cheese Burger">
                        <p><strong>Coke</strong></p>
                        <p>40 php</p>
                    </button>

					<button class="product-item">
                        <img src="{{ asset('images/mcfloat.webp') }}" alt="Cheese Burger">
                        <p><strong>McFloat</strong></p>
                        <p>40 php</p>
                    </button>
