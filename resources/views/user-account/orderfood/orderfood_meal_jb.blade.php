            ...
            <div class="products">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                    ...
                    <button class="product-item">
                        <img src="{{ asset('images/megameal.webp') }}" alt="Yum Burger">
                        <p><strong>Mega Meal</strong></p>
                        <p>40 php</p>
                    </button>
                    <!-- Cheese Burger -->
                    <button class="product-item">
                        <img src="{{ asset('images/alaking.webp') }}" alt="Cheese Burger">
                        <p><strong>Chicken Ala king</strong></p>
                        <p>40 php</p>
                    </button>
                    <!-- Fries -->
                    <button class="product-item">
                        <img src="{{ asset('images/mcnuggets.jpg') }}" alt="Fries">
                        <p><strong>Mcnuggets</strong></p>
                        <p>20 php</p>
                    </button>
