...
<body>
    ...
    <button class="brand-button selected">
		...
		<li class="active"><a href="{{ route('user.order_dessert_jb') }}"><img src="{{ asset('images/icecream.png') }}" alt="Desserts" class="sidebar-icon">Desserts</a></li>
            ...
            <div class="products">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 20px; justify-content: center;">
                    ...
                    <button class="product-item">
                        <img src="{{ asset('images/mcflurry.png') }}" alt="Yum Burger">
                        <p><strong>Mcflurry</strong></p>
                        <p>40 php</p>
                    </button>
                    <!-- Cheese Burger -->
                    <button class="product-item">
                        <img src="{{ asset('images/hotfudge.png') }}" alt="Cheese Burger">
                        <p><strong>Hot Fudge Sundae</strong></p>
                        <p>40 php</p>
                    </button>
					...
					<button class="product-item">
                        <img src="{{ asset('images/applepie.png') }}" alt="Cheese Burger">
