...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto flex justify-start space-x-8 px-4">
        ...
        <button id="itinerary"
            class="tab-item border-b-2 border-black text-black px-4 pb-1 pointer-events-none">1. Itinerary</button>
        <button id="passenger"
            class="tab-item text-gray-500 hover:text-black px-4 pb-1 pointer-events-none">2. Passenger</button>
...
<div
    ...
    style="position: absolute; top: 1080px; left: 150px; width: 920px; margin-bottom: 300px; padding: 20px; z-index: 10;">
    <!-- Button Container (Flex) -->
    <div class="flex gap-4 w-full justify-center">
       <!-- Back Button -->
<!-- Back Button -->
<button class="w-16 h-16 bg-white text-black text-2xl font-semibold flex items-center justify-center border-2 border-gray-500 hover:bg-gray-200 ml-3">
    <img src="{{ asset('images/prevstep.png') }}" alt="Previous" class="w-3 h-3">
</button>

        <!-- Next Step Button -->
<button class="w-full px-8 py-2 bg-black text-white font-semibold hover:bg-gray-600 focus:outline-none flex items-center justify-between" onclick="window.location='{{ route('user.bp-three') }}'" >
    <!-- Text Centered -->
